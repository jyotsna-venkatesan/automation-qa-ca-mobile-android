...
public class PickUpPage extends AbstractPageClass {
    ...
    public boolean enterEstateNumber() {
        try {
            ...
            String estateInput = configLoader.getProperty("ESTATE_NUMBER_SENDER");
    ...
    public boolean enterRoomFloor() {
        try{
            ...
            String roomFloor = configLoader.getProperty("ROOM_FLOOR_SENDER");
    ...
    public boolean enterName() {
        try{
            ...
            String senderName = configLoader.getProperty("SENDER_NAME");
    ...
    public boolean enterNumber() {
        try{
            ...
            String senderNumber = configLoader.getProperty("SENDER_NUMBER");
